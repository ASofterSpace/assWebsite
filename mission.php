...
@include(sectionstart.php)
	...
	<div class="content">
		A few words on what motivates us, what drives us - what we are doing all this for!
	</div>
...
@include(sectionstart.php)
	...
	<div class="content">
		...
		like <a href="https://en.wikipedia.org/wiki/File:Vega_model_-_Udvar-Hazy_Center.JPG" target="_blank">wonky insects
...
@include(sectionstart.php)
	...
	<div class="content">
		...
		we cannot at this moment promise that we will always use the unlicense for everything we produce.<br>
		The text of the license can be found <a href="/licenses/unlicense.php">here</a>.
	</div>
@include(sectionend.php)
