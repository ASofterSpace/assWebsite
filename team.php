	...
	<div class="content">
		...
		<div class="person">
			...
			<div class="picbiocontainer">
				...
				<div class="bio">
					As a consultant with Expense Reduction Analysts, Benedict has gained extensive experience as a Key Account manager, working to fulfil client needs to their expectations and beyond.<br>
